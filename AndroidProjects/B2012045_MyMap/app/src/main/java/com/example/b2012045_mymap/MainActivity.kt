...
import com.example.b2012045_mymap.databinding.ActivityMainBinding
import com.example.b2012045_mymap.models.Place
        ...
        mapAdapter = MapsAdapter(this, userMaps,
            object : MapsAdapter.OnClickListener {
                override fun onItemClick(position: Int) {
                    ...
                    val intent = Intent(this@MainActivity, DisplayMainActivity::class.java)
